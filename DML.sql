...
-- SELECT : 테이블에서 레코드는 조회할 때 사용하는 명령어
...
DELETE FROM auto_table; -- 레코드만 삭제 1234 -> DELETE -> 5678
TRUNCATE TABLE auto_table; -- 데이터의 테이블 구조를 처음으로 되돌림(초기상태로 되돌림) 1234 -> TRUNCATE -> 1234
